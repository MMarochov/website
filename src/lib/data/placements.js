export const placements = [
  {
    ...
    description:
      "Gained insight into applying geospatial data science techniques at scale for public sector data enhancements, particularly through getting to grips with Databricks.",
  },
    {
      open: true,
      org: "Ordnance Survey",
      ...
      description:
        "Spent time troubleshooting customer problems, simplified the complex to help customers understand technical concepts in an accessible manner, and introduced Git and Azure DevOps to the team, helping them upskill and use better code sharing practice.",
    },
    {
      open: true,
      org: "Ordnance Survey",
